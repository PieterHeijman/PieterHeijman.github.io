            ...
            <Popover.Content side="top" sideOffset={8} className="social-share-content">
              <ul className="links">
                <li>
                  ...
                  <a href="https://www.facebook.com/sharer.php?u=https://www.trivialdiscourse.com{{ page.url }}" target="_blank" aria-label="Share this on Facebook" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a href="https://pinterest.com/pin/create/bookmarklet/?media=https://www.trivialdiscourse.com{{ page.image }}&url=https://www.trivialdiscourse.com{{ page.url }}&description={{ page.title }}" target="_blank" aria-label="Share this on Pinterest" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a href="https://www.linkedin.com/shareArticle?url=https://www.trivialdiscourse.com{{ page.url }}&title={{ page.title }}" target="_blank" aria-label="Share this on Linkedin" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a href="https://reddit.com/submit?url=https://www.trivialdiscourse.com{{ page.url }}&title={{ page.title }}" target="_blank" aria-label="Share this on Reddit" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg"
